...
lowOrHigh.style.backgroundColor = 'green';
    ...
    lowOrHigh.textContent = 'Попробуй число побольше...';
    attempts -= 1; //уменьшили количество попыток на 1
    guesses.textContent = `У вас осталось ${attempts} попыток`; //вывели число попыток на экран
} 
} else {
...
если пользователь не угадал число и его попытки закончились, то говорим удачи дорогой пользователь повезёт в следующий раз!
*/ 
